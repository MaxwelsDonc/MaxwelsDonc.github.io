...
## Content & authoring
- **Full guide: `docs/CONTENT.md`** — how to update data files and write blog
  posts. Read it before editing content.
- All content lives in `src/data/*.json` (single source of truth, also read by
  the GitHub profile updater) and `src/content/blog/*.md`.
